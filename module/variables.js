...
const reasonDescription = [
    ...
    "Websites can easily cost tens of thousands of dollars, which is just not plausible for small businesses. I create cost-effective designs and am transparent about pricing up front. There are no hidden costs or monthly fees. ",
    "Unlike some designers who focus solely on the artistic elements of a website and ignore the user experience, my websites are designed with your customer in mind. Therefore, all of my sites are clean, modern and easy to navigate."
]
...
const servDetail = [
    ...
    "Agency specializing in building secure, scalable, custom, accessible and dynamic websites. When you work with Inorbital, you work with an experienced and talented team that’s committed to helping you achieve your project goals today and make your website future-ready for tomorrow.",
    "sEcom Service Detail On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même. L'avantage du Lorem Ipsum sur un texte générique comme 'Du texte. Du texte. Du texte.' est qu'il possède une distribution de lettres plus ou moins normale, et en tout cas comparable avec celle du français standard. De",
